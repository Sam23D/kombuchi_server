defmodule KombuchiServerWeb.Components.UserSetting do
  use Phoenix.LiveComponent
  def account_verification_progress(assigns) do
    ~H"""
      ...
      <div>
        ...
        <ol class="grid grid-cols-3 mt-4 text-sm font-medium text-gray-500">
          ...
          <li class="flex items-center justify-center text-blue-600">
            <span class="hidden sm:inline"> Verify personal info </span>
