defmodule KombuchiServerWeb.Router do
  use KombuchiServerWeb, :router

  import KombuchiServerWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {KombuchiServerWeb.LayoutView, :root}
  ...
  # scope "/api", KombuchiServerWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: KombuchiServerWeb.Telemetry
    end
  end
